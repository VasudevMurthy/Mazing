...
package com.greenleaves.mazing.game;

import android.content.Context;

import com.greenleaves.mazing.datastore.MazeDbAdapter;
import com.greenleaves.mazing.game.model.GamePlayerProfile;
import com.greenleaves.mazing.maze.generator.KruskalMazeGenerator;
...
public class GameLevelManager {
    ...
    private MazeDbAdapter mDbAdapter;
    ...
    private GameLevelManager(Context context) {
        mDbAdapter = new MazeDbAdapter(context);
